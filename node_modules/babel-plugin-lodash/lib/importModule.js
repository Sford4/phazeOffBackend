...
function resolvePath(pkgStore, name, path) {
  let base = pkgStore.base,
      id = pkgStore.id;
  const lower = name.toLowerCase();

  const module = _mapping.default.modules.get(id);
...
var _default = (0, _memoize2.default)(importModule, (pkgStore, name) => (pkgStore.path + '/' + name).toLowerCase());
